...
const NavbarLink = ({ to, icon, children, className = "", onClick }) => {
  ...
  // Classes for active vs. inactive links using your custom color properties
  // The active link has a subtle background tint of the accent color.
  const activeClass = "bg-accent/10 text-accent";
  // The inactive link uses the main text color (text-txt) and gets the tint on hover.
